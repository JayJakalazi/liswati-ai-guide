...
import { X, MessageSquare, CreditCard, Info, BookOpen, Trash2, Plus, HeartPulse, Crown, Briefcase } from "lucide-react";
...
const SideMenu = ({
  ...
  const menuItems = [
    ...
    { icon: Crown, label: "Culture", action: () => { navigate("/culture"); onClose(); } },
    { icon: Briefcase, label: "Business", action: () => { navigate("/business"); onClose(); } },
